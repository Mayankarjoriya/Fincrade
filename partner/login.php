    ...
    if (empty($username) || empty($password)) {
        ...
        if ($result['success']) {
            ...
            if ($result['user']['role'] === 'partner') {
                ...
                $error = 'Access denied. Partner only.';
...
<head>
    ...
    <title>Partner Login - Fincrade</title>
        ...
        <div class="max-w-md w-full space-y-8">
            ...
            <div class="text-center">
                ...
                <div class="mt-2 space-x-4">
                    ...
                    <a href="../admin/login.php" class="text-primary-600 hover:text-primary-500 text-sm">Admin Login</a>
                ...
                <div class="mt-4 text-xs text-gray-500">
                    ...
                    Don't have an account? Only Super Admin can create partner accounts.
